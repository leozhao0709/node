...
function provideCompilerOptionDiagnosticErrorsToWebpack(getCompilerOptionDiagnostics, compilation, instance, configFilePath) {
    if (getCompilerOptionDiagnostics) {
        ...
        utils_1.registerWebpackErrors(compilation.errors, utils_1.formatErrors(languageService.getCompilerOptionsDiagnostics(), loaderOptions, compiler, { file: configFilePath || 'tsconfig.json' }));
    }
}
/**
    ...
    Object.keys(filesToCheckForErrors)
        ...
        if (utils_1.hasOwnProperty(modules, filePath)) {
            ...
            associatedModules.forEach(function (module) {
                ...
                // append errors
                var formattedErrors = utils_1.formatErrors(errors, loaderOptions, compiler, { module: module });
            ...
            utils_1.registerWebpackErrors(compilation.errors, utils_1.formatErrors(errors, loaderOptions, compiler, { file: filePath }));
        }
    });
}
/**
